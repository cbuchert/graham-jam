...
/**
 * Scaffold a minimal scene file with the marker block, an all-zero tile array,
 * and empty spawn points. The developer fills in imports and logic below the markers.
 */
export function scaffoldSceneFile(width: number, height: number): string {
  ...
  return [
    "// Generated by scene editor — add imports, entities, and triggers below.",
    "",
    MARKER_START,
    block,
    MARKER_END,
